...
void DlgView::DoDataExchange(CDataExchange* pDX)
{
	...
	//}}AFX_DATA_MAP
	DDX_Text(pDX, IDC_EDIT1, GetDocument()->rct.left);
	DDX_Text(pDX, IDC_EDIT2, GetDocument()->rct.top);
	DDX_Text(pDX, IDC_EDIT3, GetDocument()->rct.right);
	DDX_Text(pDX, IDC_EDIT4, GetDocument()->rct.bottom);
